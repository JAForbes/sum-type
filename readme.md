...
[![pipeline status](https://gitlab.com/harth/stags/badges/master/pipeline.svg)](https://gitlab.com/harth/stags/commits/master)

[![coverage report](https://gitlab.com/harth/stags/badges/master/coverage.svg)](https://gitlab.com/harth/stags/commits/master)
...
[Check it out](https://flems.io/#0=-qOqsdsAGoHAQzhcrjd7o9nq93qV1i1NkdTudLtdbjIHk8Xm9lqtnp9vojDgDbADgSjweiodjYXisASfq1kQQZDAAEIweBcIQCXEreFEzZVP5koEgtmc7m8-kfJki46BIQlWwAD2cAD41bYAFS2Bm2HEglYMl6lIXC0XkkEiZVhbVOLXqvUGo2LE0whHCraK22FPYOrVeEAnKCwKBIWzB4GqnHvYMJIQRWwCbreECC+U+-7ixZ+gPqx1RkNhmAR4sxuMEPYJpMptPB+FZo4AKXsdx2BBsUHYAnc7FYKXt7tlI+DxmUjfh5ubpOtbY7XZkPb7A6HxtHePHYEnGens4Xne7vf7g83Kzh04tSLn4sPS5Xp-XI5f1Y+TeJVUYTIIhhgvfGLw-B8MYvXmMCqk0OYoIETRShAFgwC4bhslyawJAYJBqC0HQQGEMQJAICAwBMEArHMGQNE0ZgQDgXsAGteFQXQCIMERUR7BQQHqRADFkGRCjAJAAHphNCQp6PcIiYBEYT2IuTiAAEaAINACAoOSOM4QJe1-UiZBSQp9HAaB2EKSjtBY4y3E8HSBD0hDuKgXiQH4wSRLEgQJKkpRZJssBFKwVTVIAWigCAaDwYSInYGxhP8uyHJYAyjIkSAe3MrRGE0IA)
...
> 🤓 Types generated by stags are decorated with a lot of functions for free.  Check out [lib/decorate.js](lib/decorate.js) to see how it all works.
...
`stags` differentiates itself from other sum type library by documenting the internal structure used for types and instances of types.  This allows you to create your
own constructors/transformers in userland.  You can store the exact output
of a stags constructor in a `redux-store`, `localStorage` or even a `json` column in your favourite database.

`stags` does not care where your data came from, just that it adheres to a particular structure.

#### Ecosystem

Each module listed here adheres to the stags specification. That specification is defined at [stags/docs/spec.md](https://gitlab.com/harth/stags/tree/master/docs/spec.md).
...
Read more about `otherwise` [here](https://gitlab.com/harth/stags/blob/master/docs/otherwise.md)
